...
var (
	// DefaultSpuID holds the default value on creation for the "spu_id" field.
	DefaultSpuID int64
	// SpuIDValidator is a validator for the "spu_id" field. It is called by the builders before save.
	SpuIDValidator func(int64) error
